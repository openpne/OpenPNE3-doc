...
Member URI
    http://example.com/api.php/feeds/community/{ID of the community}

Format of Entry Document
========================

An entry for a community is described like the following Atom Entry Document:
 ...
 * /entry/author : Informations about author of this diary
