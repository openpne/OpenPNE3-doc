...
Collection URI
    http://example.com/api.php/feeds/communityTopic/community/{ID of the community}

Member URI
    http://example.com/api.php/feeds/communityTopic/{ID of the community topic}

Format of Entry Document
========================

An entry for a community topic is described like the following Atom Entry Document:
